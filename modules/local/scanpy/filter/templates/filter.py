...
if mad_enabled:
    ...
    if log1p_n_genes_by_counts_nmads > 0:
        mad_outlier |= is_outlier(adata, "log1p_n_genes_by_counts", log1p_n_genes_by_counts_nmads)
    if pct_counts_in_top_20_genes_nmads > 0:
        mad_outlier |= is_outlier(adata, "pct_counts_in_top_20_genes", pct_counts_in_top_20_genes_nmads)
