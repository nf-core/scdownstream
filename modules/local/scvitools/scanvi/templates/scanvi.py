...
if reference_model_type == "scanvi":
    ...
    labels_key = setup["labels_key"]
    if labels_key != "label":
        adata_work.obs[labels_key] = adata_work.obs["label"]

    unknwon_label = setup["unlabeled_category"]
    ...
    unique_labels = set(adata_work.obs["${label_col}"].unique())
